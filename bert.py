...
Original file is located at
    https://colab.research.google.com/drive/1BVaPdlVM78jYF4Lb_3OPUwCeXR4TlE4s

The way this script is created, we can also do prediction based on the book
"""
...
#Adding a new column to the dataset, which indicates the Testament
...
def bert_encode(string_list, tokenizer):
...
test_results = model.evaluate(X_test, dummy_y_test, verbose=False, return_dict = True)
print(test_results)
...
test_results_books = model.evaluate(X_test, dummy_y_test, verbose=False,return_dict = True)
test_results_books
